...
import { purchase } from "../../../../SPI/transaction.js";
    ...
    if (buttonname === "Do Txn") {
      ...
      if (payment_mode === "eftpos") {
        handlePrint({
          ...
          payment_mode: payment_mode,
          status: "paid",
          grand_total: parseFloat(cardamount),
        });
      } else if (payment_mode === "split payment") {
        handlePrint({
          ...printData,
          payment_mode: payment_mode,
          status: "pais",
          grand_total: Number(cashamount) + Number(cardamount),
          split_card_amount: Number(cardamount),
          split_cash_amount: Number(cashamount),
        });
      }
    }
  };
  ...
  return (
    <>
      <div className="efp-container">
        ...
        <div className="para">
          <p>
            Additional Surcharge On Card {posData.surcharge}%{" "}
