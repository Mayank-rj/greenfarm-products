...
const WeightDisplay = () => {
  ...
  useEffect(() => {
    ...
    const handleWeightMessage = (event) => {
      ...
      console.log("weight Parsed Data", parsedData);
      console.log("weight Parsed Value", parsedData.type);
      if (parsedData?.type === "weight") {
        ...
        console.log("customparsedWeight", customparsedWeight);
        if (customparsedWeight) {
          // for production
          setWeight(customparsedWeight); // for production
          handleWeight(customparsedWeight); // for production
        }
