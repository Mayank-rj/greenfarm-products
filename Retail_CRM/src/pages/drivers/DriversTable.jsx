...
const columns = [
  ...
  { width: 100, label: 'Phone no.', dataKey: 'mobile', numeric: true },
...
const DriversTable = () => {
 ...
 const handleOpenModal = (_id, value, type) => {
  ...
  useEffect(() => {
    fetchData(() => getApi('/driver'), setRows, "Unable to fetch drivers", "Fetching drivers");
  }, []);
  ...
  return (
    <Container>
      ...
      <TableSearchbar label={"Search Drivers"} searchTerm={searchTerm} handleSearch={handleSearch} />
      <AddNewTitle title={"Add New Driver"} path={`add`} />
      <Paper>
      ...
      <ConfirmationModal
        ...
        handleOnConfirm={() => statusUpdate({ title: "driver", dataToSend, successHandler, setLoading })}
        heading={"Update Driver status"}
