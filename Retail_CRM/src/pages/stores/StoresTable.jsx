...
const StoresTable = () => {
  ...
  useEffect(() => {
    fetchData(() => getApi('/store'), setRows, "Unable to fetch stores", "Fetching stores");
  }, []);
  ...
  return (
    <Container>
      ...
      <TableSearchbar label={"Search Stores"} searchTerm={searchTerm} handleSearch={handleSearch} />
      <AddNewTitle title={"Add New Store"} path={`add`} />
      <Paper>
      ...
      <ConfirmationModal
        ...
        handleOnConfirm={() => statusUpdate({ title: "store", dataToSend, successHandler, setLoading })}
        heading={"Update Store status"}
