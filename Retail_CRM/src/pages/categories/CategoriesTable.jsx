...
const CategoriesTable = () => {
  ...
  return (
    <Container>
      ...
      <TableSearchbar label={"Search Categories"} searchTerm={searchTerm} handleSearch={handleSearch} />
      <AddNewTitle title={"Add New Category"} path={`add`} />
      <Paper>
      ...
      <ConfirmationModal
        ...
        handleOnConfirm={() => statusUpdate({ title: "category", dataToSend, successHandler, setLoading })}
        heading={"Update Category status"}
