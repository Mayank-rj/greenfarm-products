...
export default function CustomerScreen() {
  ...
  useEffect(() => {
    setSurchargeAmount((parseFloat(details?.grand_total) + parseFloat(details?.discount)) - parseFloat(details?.sub_total))
  }, [details])
  return (
    ...
    <div className="main">
      ...
      <div className="main_headings">
        <div className="Sub_headings1">
          ...
          {details && details?.discount && parseFloat(details?.discount) !== 0 && details?.discount !== "" ? <p>DISCOUNT : ${details?.discount}</p> : ''}
